...
This pattern is also visible in mixed and layered polities such as [Han Guo](../states/han-guo.md), confessional monarchies such as [Cheonguk](../states/cheonguk.md), defensive frontier theocracies such as [Hayanguk](../states/hayanguk.md), river-gate kingdoms such as [Guan Guo](../states/guan-guo.md), upstream frontier monarchies such as [Longlin Guo](../states/longlin-guo.md), small defensive duchies such as [Hamcheon](../states/hamcheon.md), and sacred-sovereign centers such as [Quz Guo](../states/quz-guo.md), where legitimacy and institutional form do not map neatly onto single-ethnicity state models.
