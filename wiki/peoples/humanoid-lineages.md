# Humanoid Lineages of Eutheria

The humanoid peoples of Eutheria are treated in canon as branches of a shared ancestral stock rather than unrelated creations. Over long timescales, migration, ecological adaptation, and post-catastrophe political history produced the modern distribution of peoples.

For deep prehistory, see [Pre-Humanoid Ages](../history/pre-humanoid-ages.md).

## Shared origin model

Canonical lineages describe the following broad sequence:

1. A proto-humanoid population diverged from earlier deep prehistory.
2. Major early branches produced giant lineages and smaller humanoid lineages.
3. Ancient elven populations became a key ancestral trunk for multiple later peoples.
4. Dwarves, gnomes, and halflings represent old, early-diverged branches.
5. Humans and orcs are later branches from elven-related ancestry.

This framework is historical-biological in tone and does not eliminate religious interpretations used by different cultures.
...
Dwarven societies are strongly tied to mountain systems and underground engineering traditions. Continental variation matters significantly; see [Dwarves of Valthera and Nereth](dwarves-of-valthera-and-nereth.md).
...
Demographic recovery after Trelhelm was uneven. Human expansion accelerated in newly habitable zones, dwarven mountain reconstruction restored pass economies, and long-lived peoples prioritized continuity institutions. These patterns still shape present-state politics.
